...
function printResult(data) {
  ...
  const wrapNewClass = document.createElement('div');
  wrapNewClass.className = "wrapNewClass";
  wrapNewClass.addEventListener('click', function (e) {
    console.log(e.target.className);
    if (e.target.className.includes('userDelete')) {
  ...
  deleteBtn.innerHTML = "+";
  deleteBtn.className = "userDelete";
  ...
  infoContain.append(name, gender, email, website, skills);
  imageHyperlink.appendChild(userImage);
  imageContainer.appendChild(imageHyperlink);

  wrapNewClass.append(infoContain, imageContainer, deleteBtn);

  if (sectionHeading == null) {
    resultEl.append(wrapNewClass);
  } else {
    resultEl.append(sectionHeading, wrapNewClass)
  };
